...
🚀 Funcionalidades
- Identificação de tipo de planta (perene, moderada, etc.)
- Benefícios medicinais (calmante, digestivo, antioxidante)
- Cuidados essenciais (rega, solo, luz)
- Formas de uso (chá, tempero, infusão)

📦 Acesse aqui
👉 [Acesse o Reggrowth aqui](https://ganjabionick8.github.io/Reggrowth/)

🧠 Feito por @Ganjabionick8  ==🌿
